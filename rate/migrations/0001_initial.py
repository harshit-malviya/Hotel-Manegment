    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_slot', models.ForeignKey(help_text='Links to Time Slot Master', on_delete=django.db.models.deletion.CASCADE, related_name='rate_plans', to='timemaster.timeentry')),
            ],
            options={
